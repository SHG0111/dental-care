...
<template>
  <div class="ped-floaties">
    ...
    <svg
      class="ped ped-tooth ped-tooth-1"
      viewBox="0 0 60 60"
      width="50"
      height="50"
      aria-hidden="true"
    ...
    <svg
      class="ped ped-tooth ped-tooth-2"
      viewBox="0 0 60 60"
      width="36"
      height="36"
      aria-hidden="true"
    ...
    >
      <path
        d="M15 2l4 8.5 9.5 1.5-7 6.5 1.5 9L15 21l-8 4.5 1.5-9-7-6.5 9.5-1.5z"
        fill="#FFE5A3"
        stroke="#FFD700"
        stroke-width="0.5"
      />
    ...
    <!-- Hearts -->
    <svg
      class="ped ped-heart ped-heart-1"
      viewBox="0 0 32 32"
      width="18"
      height="18"
      aria-hidden="true"
    >
      <path
        d="M16 28S4 20 4 12a8 8 0 0 1 12-6 8 8 0 0 1 12 6c0 8-12 16-12 16z"
        fill="#FF9EB5"
        stroke="#FF7B89"
        stroke-width="0.8"
      />
    ...
    <svg
      class="ped ped-heart ped-heart-2"
      viewBox="0 0 32 32"
      width="14"
      height="14"
      aria-hidden="true"
    ...
    <!-- Clouds -->
    <svg
      class="ped ped-cloud ped-cloud-1"
      viewBox="0 0 80 40"
      width="80"
      height="40"
      aria-hidden="true"
    ...
    <svg
      class="ped ped-cloud ped-cloud-2"
      viewBox="0 0 60 30"
      width="60"
      height="30"
      aria-hidden="true"
    ...
    <!-- Balloons -->
    <svg
      class="ped ped-balloon ped-balloon-1"
      viewBox="0 0 30 42"
      width="28"
      height="40"
      aria-hidden="true"
    ...
    <svg
      class="ped ped-balloon ped-balloon-2"
      viewBox="0 0 30 42"
      width="22"
      height="34"
      aria-hidden="true"
    ...
    <!-- Butterflies -->
    <svg
      class="ped ped-butterfly ped-butterfly-1"
      viewBox="0 0 36 28"
      width="30"
      height="24"
      aria-hidden="true"
    ...
    <svg
      class="ped ped-butterfly ped-butterfly-2"
      viewBox="0 0 36 28"
      width="20"
      height="16"
      aria-hidden="true"
    ...
    <!-- Sparkles -->
    <svg
      class="ped ped-sparkle ped-sparkle-1"
      viewBox="0 0 24 24"
      width="18"
      height="18"
      aria-hidden="true"
    ...
    <svg
      class="ped ped-sparkle ped-sparkle-2"
      viewBox="0 0 24 24"
      width="14"
      height="14"
      aria-hidden="true"
